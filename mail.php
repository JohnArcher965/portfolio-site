...
if(isset($_POST['email']))	{
	// Edit as required 
	$email_to = "hello@johnathanwilson.co.uk";
...
$email_message = "Message from Website - Form details below.\n\n";
...
<script>
            function message() {
                alert(`Thank you for your message <?php print("$name") ?>, I will get back to you shortly.`);
...
<html>
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Merriweather:ital,wght@0,300;0,400;0,700;1,300&display=swap"
            rel="stylesheet">
        <link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,300;0,400;0,700;1,300;1,400&display=swap"
            rel="stylesheet">

            <title>Johnathan Wilson - Full-Stack Developer &amp; Designer </title>
    </head>
    <body onload="message()" class="container">
        ...
        <div class="sidebar">
            <div class="navigation">
                ...
                <nav class="navigation__nav">
                    <ul class="navigation__list">
                        <li class="navigation__item"><a href="/#section-about" class="navigation__link"><span>01</span>About</a>
                        </li>
                        <li class="navigation__item"><a href="/#section-skills" class="navigation__link"><span>02</span>My Skills</a></li>
                        <li class="navigation__item"><a href="/#section-projects" class="navigation__link"><span>03</span>Latest Projects</a>
                        </li>
                        <!-- <li class="navigation__item"><a href="#section-testimonials" class="navigation__link"><span>04</span>Testimonials</a></li> -->
                        <li class="navigation__item"><a href="/#section-contact" class="navigation__link"><span>04</span>Get In Touch</a></li>
                    </ul>
                </nav>
            </div>
            ...
            <div class="sidebar__social-media">
                <ul>
                    <li><a href="https://www.linkedin.com/in/johnathan-wilson-745227108/" target="_blank">
                    ...
                    <li><a href="https://github.com/JohnArcher965" target="_blank">
                        <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li><a href="https://twitter.com/JohnArcher965" target="_blank">
                    ...
                    <li><a href="https://www.instagram.com/johnarcher965/" target="_blank">
                        <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <header class="header" id="section-header">
            <div class="header__main">
                <div class="header__main-logo">
                    <img src="assets/img/logo.png" alt="Logo Image" class="header__main-logo-img moveInLeft">
                </div>
                <h1 class="heading__primary moveInLeft">Johnathan Wilson</h1>
                <h2 class="heading__secondary heading__secondary--main moveInLeft">Full-Stack Developer &amp; Designer</h2>
                <a href="/#section-contact" class="btn btn__heading header__main-btn moveInBottom">Get in touch!</a>
            </div>

            <figure class="header__headshot moveInRight">
                <img src="assets/img/headshot.png" alt="Johnathan Wilson Headshot" class="header__headshot-img">
            </figure>
        </header>
        
        <section class="skills" id="section-skills">
            
            <h2 class="skills__heading heading__secondary heading__secondary--main">
                My Skills
            </h2>

            <div class="skills__icons" >
                <div class="skill">
                    <svg viewBox="0 0 128 128" class="skills__icon skills__icon-vsc">
                        <path fill="#1b32b4"
                    ...
                    <h4 class="skill__title">Visual Stuido Code</h4>
                    <p class="skill__text">I work predominantly in VS Code, however I have previosly used Sublime and Adobe Dreamweaver</p>
                </div>
                
                <div class="skill">
                    <svg viewBox="0 0 128 128" class="skills__icon skills__icon-css">
                        <path fill="#131313"
                    ...
                    <h4 class="skill__title">CSS3</h4>
                    <p class="skill__text">I am proficient in CSS, creating elegant, responsive layouts with Flexbox, Grid and many other techniques.</p>
                </div>

                <div class="skill">
                    <svg viewBox="0 0 128 128" class="skills__icon skills__icon-html">
                    ...
                    <h4 class="skill__title">HTML 5</h4>
                    <p class="skill__text">I am proficient in HTML5, ensuring that all my markup is optimised for search engines and responsiveness.</p>
                </div>

                <div class="skill">
                    <svg viewBox="0 0 128 128" class="skills__icon skills__icon-sass">
                    ...
                    <h4 class="skill__title">Sass</h4>
                    <p class="skill__text">I am well versed in Sass use and implementation, employing BEM formatting and the 7-1 architecture.</p>
                </div>

                <div class="skill">
                    <svg viewBox="0 0 128 128" class="skills__icon skills__icon-bootstrap">
                        <path fill="#5B4282"
                    ...
                    <h4 class="skill__title">Bootstrap</h4>
                    <p class="skill__text">I prefer to design my layouts from scratch, however I can easily use Bootstrap when in a pinch.</p>
                </div>

                <div class="skill">
                    <svg viewBox="0 0 128 128" class="skills__icon skills__icon-js">
                    ...
                    <h4 class="skill__title">JavaScript</h4>
                    <p class="skill__text">I am well versed in vanilla JavaScript up to ES2018, and I am currently expanding my understanding of the latest releases.</p>
                </div>

                <div class="skill">
                    <svg viewBox="0 0 128 128" class="skills__icon skills__icon-jquery">
                        <path fill="#0868AC"
                    ...
                    <h4 class="skill__title">jQuery</h4>
                    <p class="skill__text">Similarly to Bootstrap, I prefer to avoid using the jQuery library, but happy to do so when required.</p>
                </div>

                <div class="skill">
                    <svg viewBox="0 0 128 128" class="skills__icon skills__icon-react">
                        <g fill="#61DAFB">
                    ...
                    <h4 class="skill__title">React</h4>
                    <p class="skill__text">I am familiar with the basics of React, however I continue to expand my understanding.</p>
                </div>

                <div class="skill">
                    <svg viewBox="0 0 128 128" class="skills__icon skills__icon-node">
                        <path fill="#83CD29"
                    ...
                    <h4 class="skill__title">Node</h4>
                    <p class="skill__text">I am confident with node and can quickly create a backend - creating something more complex however, naturally takes a little longer.</p>
                </div>

                <div class="skill">
                    <svg viewBox="0 0 128 128" class="skills__icon skills__icon-d3">
                        <linearGradient id="a" gradientUnits="userSpaceOnUse" x1="-201.009" y1="376.844" x2="-200.098" y2="375.873"
                        ...
                        <path fill="url(#a)"
                            d="M126.334 90.59a37.18 37.18 0 0 0 .128-1.647C126.5 88.288 87.094 50.9 87.094 50.9h-.942s39.94 42.13 40.182 39.69z">
                        </path>
                        <linearGradient id="b" gradientUnits="userSpaceOnUse" x1="-199.257" y1="373.615" x2="-197.514" y2="371.916"
                            gradientTransform="matrix(40.2105 0 0 -40.4122 8003.203 15127)">
                            <stop offset="0" stop-color="#f9a03c"></stop>
                            <stop offset="1" stop-color="#f7974e"></stop>
                        </linearGradient>
                        <path fill="url(#b)"
                            d="M42.26 77.62a26.282 26.282 0 0 1-.328.702c-1.256 2.62 17.585 21.038 19.1 18.8.07-.098.14-.202.208-.3.077-.118.152-.23.228-.348 1.213-1.84-18.67-20.05-19.207-18.854z">
                        </path>
                        <linearGradient id="c" gradientUnits="userSpaceOnUse" x1="-199.836" y1="374.252" x2="-198.286" y2="372.475"
                        ...
                        <linearGradient id="d" gradientUnits="userSpaceOnUse" x1="-201.143" y1="379.263" x2="-200.795" y2="378.804"
                        ...
                        <path fill="url(#d)"
                            d="M126.488 88.61c-.863 19.13-16.69 34.425-36.024 34.425H87.85l-19.31-19.022a69.313 69.313 0 0 0 4.38-6.98h17.544c5.55 0 10.064-4.514 10.064-10.065 0-5.55-4.515-10.064-10.064-10.064H80.082A69.373 69.373 0 0 0 81.306 64c0-4.48-.44-8.852-1.26-13.1h6.45l39.88 39.295a48.62 48.62 0 0 0 .112-1.585zM11.962 4.772H1.472v26.003h10.49c18.32 0 33.23 14.903 33.23 33.225 0 4.984-1.113 9.716-3.088 13.964L61.24 96.82A58.882 58.882 0 0 0 71.2 64c0-32.658-26.574-59.228-59.236-59.228z">
                        </path>
                        <linearGradient id="e" gradientUnits="userSpaceOnUse" x1="-200.962" y1="378.553" x2="-200.452" y2="378.218"
                        ...
                        <path fill="url(#e)"
                            d="M90.464 4.772H47.986a69.81 69.81 0 0 1 24.82 26.003h17.658c5.55 0 10.064 4.513 10.064 10.064 0 5.55-4.515 10.06-10.064 10.06h-3.968l39.88 39.296a36.65 36.65 0 0 0 .152-3.228c0-8.766-3.146-16.807-8.368-23.066 5.223-6.256 8.368-14.3 8.368-23.063 0-19.887-16.177-36.068-36.064-36.068z">
                        </path>
                        <linearGradient id="f" gradientUnits="userSpaceOnUse" x1="-200.619" y1="377.137" x2="-200.595" y2="376.532"
                            gradientTransform="matrix(176.7653 0 0 -92.6293 35504.598 35022.56)">
                            <stop offset="0" stop-color="#f9a03c"></stop>
                            <stop offset="1" stop-color="#f7974e"></stop>
                        </linearGradient>
                        <path fill="url(#f)"
                            d="M87.85 123.035H48.29a69.95 69.95 0 0 0 20.25-19.022l19.31 19.022zM61.24 96.82L42.106 77.965c-5.287 11.362-16.807 19.264-30.143 19.264H1.472v26h10.49c20.53 0 38.648-10.5 49.28-26.407z">
                        </path>
                    </svg>
                    <h4 class="skill__title">D3</h4>
                    <p class="skill__text">I am familiar with the basics of D3 and can create appealing and informative interactive visualisations of data.</p>
                </div>

                <div class="skill">
                    <svg viewBox="0 0 128 128" class="skills__icon skills__icon-mongo">
                    ...
                    <h4 class="skill__title">Mongo DB</h4>
                    <p class="skill__text"></p>
                </div>

                <div class="skill">
                    <svg viewBox="0 0 128 128" class="skills__icon skills__icon-npm">
                        <path id="original-wordmark" fill="#cb3837"
                    ...
                    <h4 class="skill__title">Node Package Manager</h4>
                    <p class="skill__text"></p>
                </div>

                <div class="skill">
                    <svg viewBox="0 0 128 128" class="skills__icon skills__icon-babel">
                        <g id="original">
                            <path
                    ...
                    <h4 class="skill__title">Babel</h4>
                    <p class="skill__text"></p>
                </div>

                <div class="skill">
                    <svg viewBox="0 0 128 128" class="skills__icon skills__icon-webpack">
                        <g id="original">
                            <path fill="#8ed6fb"
                    ...
                    <h4 class="skill__title">Webpack</h4>
                    <p class="skill__text"></p>
                </div>

                <div class="skill">
                    <svg viewBox="0 0 128 128" class="skills__icon skills__icon-express">
                    ...
                    <h4 class="skill__title">Express</h4>
                    <p class="skill__text"></p>
                </div>

                <div class="skill">
                    <svg viewBox="0 0 128 128" class="skills__icon skills__icon-python">
                        <linearGradient id="a" gradientUnits="userSpaceOnUse" x1="70.252" y1="1237.476" x2="170.659" y2="1151.089"
                        ...
                        <linearGradient id="b" gradientUnits="userSpaceOnUse" x1="209.474" y1="1098.811" x2="173.62" y2="1149.537"
                            gradientTransform="matrix(.563 0 0 -.568 -29.215 707.817)">
                    ...
                    <h4 class="skill__title">Python</h4>
                    <p class="skill__text"></p>
                </div>

                <div class="skill">
                    <svg viewBox="0 0 128 128" class="skills__icon skills__icon-photoshop">
                    ...
                    <h4 class="skill__title">Photoshop</h4>
                    <p class="skill__text"></p>
                </div>

                <div class="skill">
                    <svg viewBox="0 0 128 128" class="skills__icon skills__icon-illustrator">
                    ...
                    <h4 class="skill__title">Illustrator</h4>
                    <p class="skill__text"></p>
                </div>

                <div class="skill">
                    <svg viewBox="0 0 128 128" class="skills__icon skills__icon-github">
                        <g fill="#181616">
                    ...
                    <h4 class="skill__title">Github</h4>
                    <p class="skill__text"></p>
                </div>

                <div class="skill">
                    <svg viewBox="0 0 128 128" class="skills__icon skills__icon-git">
                        <path fill="#F34F29"
                    ...
                    <h4 class="skill__title">Git</h4>
                    <p class="skill__text"></p>
                </div>
            </div>

            <div class="skills__working-on">
                <h3 class="skills__working-on--subheading">What I'm Currently Working On:</h3>
                <p class="skills__working-on--text u-mt-sm">
                    I am currently working on improving my React and Node skills, as well as improving my vanilla JavaScript. I'm taking part in the <span>100 Days Of Code</span> challenge on Twitter, feel free to follow along.
                </p>
                <a href="/#section-projects" class="btn btn__skills u-mt-sm">Check out my projects</a>
            </div>
        ...
        <section class="about" id="section-about">
            <div class="about__wrapper">
                <h2 class="about__heading heading__secondary heading__secondary--main">
                    About
                </h2>

                <div class="about__main">
                    <figure class="about__image about__image--main">
                        <img src="assets/img/headshot2.jpg" alt="A headshot of Johnathan Wilson">
                    </figure>

                    <div class="about__text">
                        <h2 class="about__text--heading heading__secondary heading__secondary--sub move">Johnathan Wilson</h2>
                        <h3 class="about__text--subheading heading__tertiary u-mt-sm">Full-Stack Web Developer &amp; Designer</h3>
                        <p class="about__text--text u-mt-sm">I have been coding since I was thirteen, ever since we had a computer in the house. I checked out <span>The Complete Idiots Guide To Web Design</span> from our local library and worked through it cover to cover. I was so upset when it was due for return that my parent's bought me a copy, in addition to some other materials. My father was a teacher, so was happy that I was learning something rather than playing games. Over ten years later I still have that book.</p>
                        <p class="about__text--text u-mt-sm">I grew up in <span>Rural Lincolnshire</span> so I have always had a passion for the outdoors. Lincolnshire is very flat, so natually I enjoy cycling, however I also like to get away to the Lake District whenever possible for hiking and light mountaineering. I also enjoy some extreme sports such as Skiing and Scuba Diving, and I am a <span>BSAC Qualified Sports Diver</span>. I love skiing in Europe, and frequent the <span>Pyrenees and the Italian Alps</span>. Egypt is my favourite place for Diving, however unfortunately I haven't been able to go for some time. When I'm not working, I'm always up for an Age of Empire's II session.</p>
                        <p class="about__text--text u-mt-sm">I enjoy spending time with friends and family, featuring the occasional day trip to <span>Brighton</span>. I can often find myself engrossed in a project so entirely, that I forget to eat, however, when I do come up for food, I would say my favorite is Italian, specifically Carbonara.</p>
                    </div>
                    <a href="https://www.instagram.com/johnarcher965/" target="_blank" class="btn btn__skills u-mt-sm u-ml-md">Check out my instagram for more</a>
                </div>

                <div class="about__gallery">
                    <figure class="about__gallery-image">
                        <img src="assets/img/raw/onvacation.jpg">
                    </figure>
                    <figure class="about__gallery-image">
                        <img src="assets/img/raw/outwithfriends.jpg">
                    </figure>
                    <figure class="about__gallery-image">
                        <img src="assets/img/raw/withmother.jpg">
                    </figure>
                </div>
            </div>
        </section>
        ...
        <section class="projects" id="section-projects">
            ...
            <div class="project">
                <figure class="project__image">
                    <img src="assets/img/raw/portfolio/glamgrazing_port.png" alt="Glam Grazing portfolio image">
                </figure>
                    <h3 class="heading__tertiary project__right-heading">Glam Grazing</h3>
                    <h4 class="project__right-subheading">Grazing Boxes for delivery<span> - Surrey, England</span></h4>
                    
                    <p class="project__right-text">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Modi, eveniet veritatis impedit, tenetur, nisi earum nesciunt officia natus enim possimus ex quasi laboriosam cum. Aspernatur exercitationem non perferendis autem saepe?
                    </p>

                    <div class="project__right-technologies">
                        <svg viewBox="0 0 128 128" class="project__icon project__icon-html">
                            <path fill="#E44D26" d="M27.854 116.354l-8.043-90.211h88.378l-8.051 90.197-36.192 10.033z"></path>
                            <path fill="#F16529" d="M64 118.704l29.244-8.108 6.881-77.076h-36.125z"></path>
                            <path fill="#EBEBEB"
                                d="M64 66.978h-14.641l-1.01-11.331h15.651v-11.064h-27.743l.264 2.969 2.72 30.489h24.759zM64 95.711l-.049.013-12.321-3.328-.788-8.823h-11.107l1.55 17.372 22.664 6.292.051-.015z">
                        ...
                        <svg viewBox="0 0 128 128" class="project__icon project__icon-css">
                            <path fill="#131313"
                                d="M89.234 5.856h-7.384l7.679 8.333v3.967h-15.816v-4.645h7.678l-7.678-8.333v-3.971h15.521v4.649zm-18.657 0h-7.384l7.679 8.333v3.967h-15.817v-4.645h7.679l-7.679-8.333v-3.971h15.522v4.649zm-18.474.19h-7.968v7.271h7.968v4.839h-13.632v-16.949h13.632v4.839z">
                            </path>
                            <path fill="#1572B6" d="M27.613 116.706l-8.097-90.813h88.967l-8.104 90.798-36.434 10.102-36.332-10.087z"></path>
                        ...
                        <svg viewBox="0 0 128 128" class="project__icon project__icon-js">
                            <path fill="#F0DB4F" d="M1.408 1.408h125.184v125.185h-125.184z"></path>
                            <path fill="#323330"
                                d="M116.347 96.736c-.917-5.711-4.641-10.508-15.672-14.981-3.832-1.761-8.104-3.022-9.377-5.926-.452-1.69-.512-2.642-.226-3.665.821-3.32 4.784-4.355 7.925-3.403 2.023.678 3.938 2.237 5.093 4.724 5.402-3.498 5.391-3.475 9.163-5.879-1.381-2.141-2.118-3.129-3.022-4.045-3.249-3.629-7.676-5.498-14.756-5.355l-3.688.477c-3.534.893-6.902 2.748-8.877 5.235-5.926 6.724-4.236 18.492 2.975 23.335 7.104 5.332 17.54 6.545 18.873 11.531 1.297 6.104-4.486 8.08-10.234 7.378-4.236-.881-6.592-3.034-9.139-6.949-4.688 2.713-4.688 2.713-9.508 5.485 1.143 2.499 2.344 3.63 4.26 5.795 9.068 9.198 31.76 8.746 35.83-5.176.165-.478 1.261-3.666.38-8.581zm-46.885-37.793h-11.709l-.048 30.272c0 6.438.333 12.34-.714 14.149-1.713 3.558-6.152 3.117-8.175 2.427-2.059-1.012-3.106-2.451-4.319-4.485-.333-.584-.583-1.036-.667-1.071l-9.52 5.83c1.583 3.249 3.915 6.069 6.902 7.901 4.462 2.678 10.459 3.499 16.731 2.059 4.082-1.189 7.604-3.652 9.448-7.401 2.666-4.915 2.094-10.864 2.07-17.444.06-10.735.001-21.468.001-32.237z">
l.243-.1c.498 1.84.735 3.657.597 5.507zm25.158-19.379c-.235 1.424-.529 2.849-.945 4.229-1.438 4.777-3.285 9.406-5.282 13.973-.369.845-.906 1.616-1.373 2.417-.072.124-.179.231-.283.334-.578.571-1.126.541-1.418-.206-.34-.868-.549-1.797-.729-2.716-.121-.617-.092-1.265-.13-1.897.039-4.494 1.41-8.578 3.736-12.38.959-1.568 2.003-3.062 3.598-4.054.49-.305 1.04-.55 1.595-.706.85-.239 1.372.154 1.231 1.006zm17.164 21.868l6.169-7.203c.257 2.675-4.29 8.015-6.169 7.203zm19.703-4.847c-.436.25-.911.43-1.358.661-.409.212-.544-.002-.556-.354-.008-.239.027-.489.093-.721.833-2.938 2.366-5.446 4.647-7.486l.16-.082c1.085 3.035-.169 6.368-2.986 7.982z">
                            </path>
                        </svg>
                    ...
                    <div class="project__right-buttons">
                        <a href="#" class="btn btn__project">Live Site</a>
                    </div>
            </div>

            <div class="project-r">
                <figure class="project-r__image">
                    <img src="assets/img/raw/portfolio/Budgety.png" alt="Budgety portfolio image">
                </figure>
                <h3 class="heading__tertiary project-r__right-heading">Budgety</h3>
                <h4 class="project-r__right-subheading">Monthly Budget Tracking App</h4>
            
                <p class="project-r__right-text">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Modi, eveniet veritatis impedit, tenetur, nisi earum
                    nesciunt officia natus enim possimus ex quasi laboriosam cum. Aspernatur exercitationem non perferendis autem
                    saepe?
                </p>
            
                <div class="project-r__right-technologies">
                    <svg viewBox="0 0 128 128" class="project__icon project__icon-html">
                        <path fill="#E44D26" d="M27.854 116.354l-8.043-90.211h88.378l-8.051 90.197-36.192 10.033z"></path>
                        <path fill="#F16529" d="M64 118.704l29.244-8.108 6.881-77.076h-36.125z"></path>
                        <path fill="#EBEBEB"
                ...
                <div class="project-r__right-buttons">
                    <a href="#" class="btn btn__project">Live Site</a>
                </div>
            </div>
            ...
            <div class="project">
                <figure class="project__image">
                    <img src="assets/img/raw/portfolio/forkify.png" alt="Forkify portfolio image">
                </figure>
                <h3 class="heading__tertiary project__right-heading">Forkify</h3>
                <h4 class="project__right-subheading">The Recipe App</h4>
            ...
            <div class="project-r">
                <figure class="project-r__image">
                    <img src="assets/img/raw/portfolio/natours_port.png" alt="Natours portfolio image">
                </figure>
                <h3 class="heading__tertiary project-r__right-heading">Natours</h3>
                <h4 class="project-r__right-subheading">Nature Tours Around the world</h4>
            ...
            <!-- <div class="projects__full-portfolio">
                <a href="/portfolio/" class="btn btn__portfolio">Check out my full portfolio</a>
            </div> -->
        ...
        <footer class="footer" id="section-contact">
            <div class="footer__content">
                <ul class="nav">
                    <li class="nav__item"><a href="/#section-header" class="nav__link">Home</a></li>
                    <li class="nav__item"><a href="/#section-skills" class="nav__link">Skills</a></li>
                    <li class="nav__item"><a href="/#section-about" class="nav__link">About</a></li>
                    <!-- <li class="nav__item"><a href="#" class="nav__link">Profile</a></li> -->
                    <li class="nav__item"><a href="/#section-projects" class="nav__link">Latest Projects</a></li>
                ...
                <div class="footer__form">
                    <form action="mail.php" method="POST" class="form">
                        ...
                        <div class="form__group">
                            <textarea name="comment" id="comment" class="form__input"  placeholder="Message"></textarea>
            ...
            <p class="copyright">
                &copy; Copyright 2021 Johnathan Wilson. All rights reserved.
            </p>
        </footer>
